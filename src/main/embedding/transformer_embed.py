...
def main():
    ...
    chunk_jsonl_path = Path("data/processed/transformer_chunks.jsonl")

    # Output: embeddings + enriched chunks
    embeddings_output_path = Path("data/processed/transformer_embeddings.npy")
    enriched_chunks_output_path = Path("data/processed/transformer_chunks_enriched.jsonl")
