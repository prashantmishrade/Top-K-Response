...
def main():
    ...
    chunk_jsonl_path = Path("data/processed/rag_paper_chunks.jsonl")

    # Output: embeddings + enriched chunks
    embeddings_output_path = Path("data/processed/rag_paper_embeddings.npy")
    enriched_chunks_output_path = Path("data/processed/rag_paper_chunks_enriched.jsonl")
